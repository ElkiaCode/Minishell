...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/23 22:37:31 by lpolizzi          #+#    #+#             */
/*   Updated: 2025/01/23 22:37:32 by lpolizzi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	fill_result(t_tokens *result, char *new_token, int new_size,
		int type)
{
...
static void	process_token(t_global *data, t_tokens *token, t_tokens *result,
		int i)
{
	char	*new_token;
